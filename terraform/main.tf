...
module "api_gateway" {
  ...
  create_note_arn  = module.lambda_create_note.invoke_arn
  delete_note_arn  = module.lambda_delete_note.invoke_arn
  get_note_arn     = module.lambda_get_note.invoke_arn
  list_notes_arn   = module.lambda_list_notes.invoke_arn
  update_note_arn  = module.lambda_update_note.invoke_arn
}
